...
zig cc \
  ...
  "$ROOT_DIR/tests/fixtures/elf/zig/zig_external_data_target.S" \
  "$ROOT_DIR/tests/fixtures/elf/zig/zig_external_data_main.c" \
...
zig build-obj \
  ...
  "$ROOT_DIR/tests/fixtures/elf/zig/zig_external_data_runtime.zig"
