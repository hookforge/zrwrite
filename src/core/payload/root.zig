...
pub const analyzeObjectBytesForFormat = object.analyzeObjectBytesForFormat;
pub const linkObject = object.linkObject;
pub const linkObjectBytes = object.linkObjectBytes;
pub const linkObjectBytesForFormat = object.linkObjectBytesForFormat;
pub const linkObjectBytesForFormatWithImageBases = object.linkObjectBytesForFormatWithImageBases;
